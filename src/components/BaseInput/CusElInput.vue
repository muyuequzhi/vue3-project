...
const whiteList = ['select', 'time', 'org']
const validateObj = {
  phone: /^1[3-9]\d{9}$/,
...
const isError = computed(() => {
  ...
  if (props.itemType) {
    if (whiteList.includes(props.itemType)) {
      return false
    }
...
<template>
  <div class="item-input">
    ...
    <div class="input-box" :class="isError ? 'input-error' : ''" v-if="type == 'input' && itemType == 'input'">
    ...
    <div class="input-box" :class="isError ? 'input-error' : ''" v-if="type == 'input' && itemType == 'time'">
      <el-date-picker
    ...
    <div class="input-box" :class="isError ? 'input-error' : ''" v-if="type == 'input' && itemType == 'select'">
      <el-select @change="emit('update:modelValue', inputVal)" v-model="inputVal" placeholder="Select" size="large" style="width: 240px">
